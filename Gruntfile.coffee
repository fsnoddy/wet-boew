...
module.exports = (grunt) ->
	...
	@registerTask(
		...
		->
			if process.env.TRAVIS_PULL_REQUEST isnt true and process.env.DIST_REPO isnt `undefined` and ( process.env.TRAVIS_TAG isnt `undefined` or process.env.TRAVIS_BRANCH is "convert-post-build" )
				grunt.task.run [
					"copy:deploy"
					"gh-pages:travis"
					"wb-update-examples"
		...
		"wb-update-examples":
			travis:
				options:
					...
					branch: repo: process.env.DEMOS_BRANCH
					silent: true
